...
matplot(t(cc.scaled), ylab = "Scaled Responses", xaxt="n", type="l", col=cc2010.clean$BASIC2010, 
...
require(lattice)
parallelplot(cc2010.clean[,-c(1,2)], col = cc2010.clean$BASIC2010, 
...
```{r p6_a, echo=F, comment=NA, message=F, warning=F}
cc2010.ranks <- cc2010.clean
cc2010.ranks[,-1] <- apply(cc2010.ranks[,-1], 2, rank)
```
